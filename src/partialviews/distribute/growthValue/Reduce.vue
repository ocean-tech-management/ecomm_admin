    ...
    <div style="margin-top: 60px;">
      ...
      <el-form :model="formData" label-width="100px">
        <el-form-item label="指定用户" prop="uid">
          <el-select class="standard-select" placeholder="需要指定要扣减的用户" v-model="formData.uid" @change="updateSelectUser">
        ...
        <el-form-item label="扣减成长值" prop="growth_value">
