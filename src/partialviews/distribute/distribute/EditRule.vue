<template>
  <div>
    <el-form :model="formData" label-width="150px">
      ...
      <!-- 团长级别最低，不需要直推要求 -->
      <el-form-item v-if="formData.level != 3" label="直推条件">
      ...
      <el-form-item label="升级成长值要求">
        <el-input style="width: 300px" type="number" auto-complete="off" placeholder="成长值，大于0的整数" v-model="formData.growth_value"></el-input>
        <div class="form-tips">最多两位小数哦</div>
      </el-form-item>
      <!-- 团长级别最低，不需要团队培养要求 -->
      <el-form-item v-if="formData.level != 3" label="团队培养条件">
      ...
      <el-form-item label="降级门槛">
        <el-input style="width: 300px" type="number" auto-complete="off" placeholder="降级成长值，大于0的整数" v-model="formData.demotion_growth_value"></el-input>
        <div class="form-tips">最多两位小数哦</div>
      </el-form-item>
      ...
      <el-form-item label="感恩奖一级分佣抽成">
        <el-input style="width: 200px" type="number" auto-complete="off" placeholder="感恩奖一级分佣抽成比例" v-model="formData.gratefulVdcOneVal">
          <template slot="append">%</template>
        </el-input>
        <div class="form-tips">备注：0~100之间，最多保留一位小数哦</div>
      </el-form-item>
      <el-form-item label="感恩奖二级分佣抽成">
        <el-input style="width: 200px" type="number" auto-complete="off" placeholder="感恩奖二级分佣抽成比例" v-model="formData.gratefulVdcTwoVal">
          <template slot="append">%</template>
        </el-input>
        <div class="form-tips">备注：0~100之间，最多保留一位小数哦</div>
      </el-form-item>
      
      <!-- 只有比lv3低等级的vip才显示大礼包图片 -->
      ...
      <!-- <el-form-item v-if="formData.level != 3" label="团队销售额类别">
        <el-select class="standard-select" placeholder v-model="formData.sales_team_level">
          <el-option label="直属团队" :value="1"></el-option>
          <el-option label="整个团队" :value="2"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item v-if="formData.level != 3" label="升级销售额">
        <el-input style="width: 300px" type="number" auto-complete="off" placeholder="升级销售额" v-model="formData.sales_price"></el-input>
        <div class="form-tips">备注：最多保留两位小数哦</div>
      </el-form-item> -->
