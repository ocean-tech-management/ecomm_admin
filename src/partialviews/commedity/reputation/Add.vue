  ...
  <div>
    <el-form :model="formData" label-width="100px">
      ...
      <el-form-item label="关联产品" prop="link_product">
        ...
        >
          <el-option label="请输入关键词" :value="null"></el-option>
      ...
      <el-form-item label="是否置顶">
        <el-checkbox :true-label="1" :false-label="2" v-model="formData.is_top">置顶</el-checkbox>
      </el-form-item>

      <el-form-item label="是否精选">
        <el-checkbox :true-label="1" :false-label="2" v-model="formData.is_featured">精选</el-checkbox>
      </el-form-item> -->
