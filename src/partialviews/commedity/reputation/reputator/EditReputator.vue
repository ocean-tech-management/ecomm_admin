    ...
    <el-form :model="formData" label-width="100px">
      <el-form-item label="关联用户" prop="uid">
        <el-select 
          name="uid"
          style="width: 300px" 
          :placeholder="formData.link_user_origin ? formData.link_user_name : '请输入关键词'" 
        ...
        >
          <el-option :label="formData.link_user_origin ? formData.link_user_name : '请输入关键词'" value></el-option>
