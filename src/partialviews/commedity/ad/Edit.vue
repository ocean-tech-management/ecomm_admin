  ...
  <div>
    <el-form :model="formData" label-width="100px">
      ...
      <!-- <el-form-item label="展示位">
        <el-select placeholder="请选择展示位" name="position_name" v-model="formData.position_name">
          <el-option label="Banner位置" value="Banner位置"></el-option>
          <el-option label="位置2" value="位置2"></el-option>
        </el-select>
      </el-form-item> -->
      <el-form-item label="跳转类型">
        ...
        <div style="color: #999; font-size:14px; line-height: 1.4; margin-top: 10px">您拥有的权限不同，可以创建的广告图跳转类型可能会有不一样的可选项哦
        </div>
      </el-form-item>
      <el-form-item label="展示图">
        ...
        <div style="color: #999; font-size:14px; line-height: 1.4; margin-top: 10px">请上传尺寸为340px*489px的图片，不超过2M</div>
      </el-form-item>
      ...
      <el-form-item label="排序">
        <el-input style="width: 450px" auto-complete="off" type="number" placeholder="填一下新广告位的排序呗，必须是正整数哦"
