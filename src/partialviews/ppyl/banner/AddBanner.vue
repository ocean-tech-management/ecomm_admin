<template>
  <div>
    <el-form :model="formData" label-width="100px">
      <el-form-item label="拼拼广告名称">
        <el-input style="width: 450px" auto-complete="off" placeholder="填一下新拼拼广告的名称呗" v-model="formData.title"></el-input>
      </el-form-item>
      ...
      <el-form-item label="排序">
        <el-input style="width: 450px" auto-complete="off" type="number" placeholder="填一下新拼拼广告的排序呗，必须是正整数哦" v-model="formData.sort"></el-input>
      </el-form-item>
