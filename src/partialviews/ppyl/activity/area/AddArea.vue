  ...
  <div>
    <el-form :model="formData" label-width="120px">
      ...
      <el-form-item label="单次回购增量">
        <el-input style="width: 450px" auto-complete="off" type="number" placeholder="单次回购增量，正整数" v-model="formData.repurchase_increment"></el-input>        <div class="form-tips">每发货N倍单次回购数量，用户获得N倍单次发货增量（eg：发2可回购3，发4即可回购6）</div>
      </el-form-item>
...
import params from '../../../../views/commedities/params/params.vue';
export default {
  components: { params },
  name: 'AddPpylActivityArea',
  data() {
    return {
      token: {
