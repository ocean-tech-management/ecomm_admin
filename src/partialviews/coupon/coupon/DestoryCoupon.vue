<template>
  <div>
    <el-form :model="formData" label-width="160px">
        <el-form-item label="销毁用户已领的优惠券">
          <el-radio-group name="deleteUserCoupon" v-model="formData.deleteUserCoupon">
            <el-radio :label="true">是</el-radio>
            <el-radio :label="false">否</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item v-if="formData.deleteUserCoupon" label="是否补偿被销券的用户">
          <el-radio-group name="compensate" v-model="formData.compensateCoupon">
            <el-radio :label="true">是</el-radio>
            <el-radio :label="false">否</el-radio>
          </el-radio-group>
        </el-form-item>
        <template v-if="formData.deleteUserCoupon && formData.compensateCoupon">
