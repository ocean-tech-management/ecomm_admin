        ...
        <el-form>
          ...
          <el-form-item label="" label-width="0">
            <el-table style="width: 100%" :data="formData.goods">
              ...
              <el-table-column label="赠送健康豆" width="150">
                <template slot-scope="scope">
                  <el-input style="width: 120px" auto-complete="off" placeholder="大于0的正数" v-model="formData.goods[scope.$index].exchange_value" type="number"></el-input>
                </template>
              </el-table-column>
              <!-- <el-table-column label="专区库存" width="150">
                <template slot-scope="scope">
                  <el-input style="width: 120px" auto-complete="off" placeholder="大于0的正数" v-model="formData.goods[scope.$index].stock" type="number"></el-input>
                </template>
              </el-table-column> -->
<!-- 
      ...
      confirmSku() {
        if(!this.sku[this.skuIndex].isAll) {
          ...
          let item = {
            ...
            stock_number: this.sku[this.skuIndex].stock,
