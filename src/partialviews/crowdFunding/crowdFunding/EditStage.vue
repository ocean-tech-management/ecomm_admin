  ...
  <div>
    <el-form :model="formData" label-width="285px">
      ...
      <el-form-item label="销售额">
        <div class="form-content-static">{{ formData.sales_price }}</div>
        <!-- <el-input style="width: 300px" auto-complete="off" type="number" placeholder="销售额，必须是正数" v-model="formData.sales_price"></el-input> -->
      </el-form-item>
