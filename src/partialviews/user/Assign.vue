<template>
  <div>
    <el-form :model="formData" label-width="80px">
      ...
      <el-form-item label="指定等级" prop="level">
        <el-select class="standard-select" placeholder v-model="formData.level" @change="$forceUpdate()">
          <el-option label="仅指定上级" :value="0"></el-option>
    ...
    <div style="margin-top: 60px;">
      ...
      <el-form :model="formData" label-width="80px">
        <el-form-item label="指定上级" prop="link_user">
          <el-select class="standard-select" placeholder="不指定任何上级" v-model="formData.link_user" @change="$forceUpdate()">
            <el-option :label="formData.link_superior_user ? formData.link_user_name : '不指定任何上级'" :value="null"></el-option>
        ...
        <el-form-item label="当前上级" prop="level">
          <div class="form-content-static">{{formData.link_user_name || '暂未指定'}}</div>
        </el-form-item>
      </el-form>
    </div>
  </div>
