<template>
  <div>
    <el-form :model="formData" label-width="80px">
      <el-form-item label="指定等级" prop="team_shareholder_level">
        <el-select class="standard-select" placeholder v-model="formData.team_shareholder_level" @change="$forceUpdate()">
