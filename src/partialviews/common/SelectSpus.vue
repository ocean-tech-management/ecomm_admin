          ...
          <div class="discount-commodity-select">
            <div class="commodity-select-wrapper commodity-spus">
              <div 
                ...
                :class="{'commodity-select-item': true, 'active': spuIndex == index}" 
                :key="item.goods_sn" 
                @click="selectSpu(index)"
                @dblclick="shouldSelectAllSku"
              >{{item.title}}</div>
            ...
            <div v-show="type == 2" class="commodity-select-wrapper commodity-skus">
              <div 
                ...
                :class="{'commodity-select-item': true, 'active': skuIndex == index}" 
                :key="item.sku_sn" 
            ...
            <div class="commodity-select-wrapper commodity-result">
              <div v-for="(item, index) in selectResults" class="commodity-select-item" :title="item.title + ' (' + item.attrs + ')'" :key="index">
