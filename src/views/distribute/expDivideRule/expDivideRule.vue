  ...
  <div class="subpage-content">
    <div class="default-container">
      ...
      <div class="table-ctrls">
        <div class="table-title">体验中心分润规则</div>
      </div>
      <el-table style="width: 100%" :data="dataList">
        <el-table-column label="等级" prop="level" width="80"></el-table-column>
        <el-table-column label="称号" prop="name" width="150"></el-table-column>
        ...
        <el-table-column label="操作">
         <template slot-scope="scope">
          <template v-if="$auths.includes('expDivide/update')">
...
<script>
import Edit from '@/partialviews/distribute/expDivideRule/EditRule';
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$get('/admin/expDivide/list', queryVal, res => {
    ...
    showEdit(row) {
      ...
      this.$get('/admin/expDivide/info', params, res => {
        let data = res.data;
    ...
    editItem() {
      ...
      this.$post('/admin/expDivide/update', params, res => {
