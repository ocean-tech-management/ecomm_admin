  ...
  <div class="subpage-content">
    <div class="default-container">
      ...
      <div class="table-ctrls">
        <div class="table-title">广宣奖规则</div>
      </div>
      <el-table style="width: 100%" :data="dataList">
        ...
        <el-table-column label="操作">
         <template slot-scope="scope">
          <template v-if="$auths.includes('propagandaRewardRule/info')">
...
<script>
import Edit from '@/partialviews/distribute/propagandaRewardRule/EditRule';
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$get('/admin/propagandaRewardRule/list', queryVal, res => {
    ...
    showEditLeaderRule(row) {
      ...
      this.$get('/admin/propagandaRewardRule/info', params, res => {
        let data = res.data;
        this.formData = {
          id: data.id,
          level: data.level,
    ...
    editLeaderRule() {
      ...
      this.$post('/admin/propagandaRewardRule/update', params, res => {
