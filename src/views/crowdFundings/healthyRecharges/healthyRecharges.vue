  ...
  <div class="subpage-content">
    <div class="default-container">
      ...
      <div class="table-ctrls">
        <div class="table-title">系统健康豆充值记录列表</div>
        <div class="table-ctrl">
          <el-button type="primary" @click="exportExcel">导出数据</el-button>
          <template v-if="$auths.includes('finance/rechargeHealthyBalance')">
            <el-button class="excel-uploader" type="primary" @click="onClickImport">导入用户列表</el-button>
            <a href="/static/docs/健康豆充值模版.xlsx" target="blank">
      ...
      <el-table style="width: 100%" :data="dataList">
        ...
        <el-table-column label="渠道" width="120" align="center">
          <template slot-scope="scope">
            {{channelTypeTexts[scope.row.healthy_channel_type]}}
          </template>
        </el-table-column>
...
import ImportUsers from "@/partialviews/crowdFunding/healthyRecharges/ImportUsers";
export default {
  name: 'healthyBalances',
  ...
  methods: {
    ...
    getList() {
      ...
      this.$get('/admin/finance/healthyBalanceList', queryVal, res => {
    ...
    exportExcel() {
      ...
      this.$get('/admin/finance/healthyBalanceList', params, res => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "健康豆充值列表");

        let time = moment().format('YYYYMMDDHHmm');
        /* generate file and send to client */
        XLSX.writeFile(wb, `健康豆充值列表${time}.xlsx`);
      });
    },
