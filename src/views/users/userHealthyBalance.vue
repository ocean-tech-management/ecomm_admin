    ...
    <div class="subpage-content">
      <div class="default-container">
        ...
        <el-table style="width: 100%" :data="dataList">
          ...
          <el-table-column label="健康豆数量" width="180" prop="price"></el-table-column>
          ...
          <el-table-column label="福利活动区编码" width="150" prop="crowd_code"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$get("/admin/healthy/balance", queryVal, (res) => {
    ...
    getSummary() {
      ...
      let params = {
        uid: this.uid,
        type: 3, // 1-集品券 2-集品豆 3-健康豆 4-礼品券
      };
    ...
    exportExcel() {
      ...
      this.$get('/admin/healthy/balance', params, res => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "健康豆明细列表");

        let time = moment().format('YYYYMMDDHHmm');
        /* generate file and send to client */
        XLSX.writeFile(wb, `健康豆明细列表${time}.xlsx`);
      });
    },
