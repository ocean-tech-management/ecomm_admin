    ...
    <div class="subpage-content">
      <div class="default-container">
        ...
        <el-table style="width: 100%" :data="dataList">
          ...
          <el-table-column label="积分(集品豆)数量" width="160" prop="price"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$get("/admin/integral/balance", queryVal, (res) => {
    ...
    getSummary() {
      ...
      let params = {
        uid: this.uid,
        type: 2, // 1-集品券 2-集品豆 3-健康豆 4-礼品券
      };
    ...
    exportExcel() {
      ...
      this.$get('/admin/integral/balance', params, res => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "集品豆明细列表");

        let time = moment().format('YYYYMMDDHHmm');
        /* generate file and send to client */
        XLSX.writeFile(wb, `集品豆明细列表${time}.xlsx`);
      });
    },
